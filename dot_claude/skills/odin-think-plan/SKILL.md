...
| ID | タスク名 | TDDフェーズ | 依存タスク | 見積もり(分) | リスク | Wave |
|----|---------|-----------|----------|------------|------|------|
| T-001 | {タスク名} | {Red/Green/Refactor/Setup} | - | {N} | {低/中/高} | {1} |
| T-002 | {タスク名} | {Red} | T-001 | {N} | {低} | {1} |
...
